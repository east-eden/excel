...
{
    /// <summary>
    /// Processing configuration options and callbacks for IExcel.AsDataSet().
    /// </summary>
    public class ExcelDataSetConfiguration
    {
        ...
        /// </summary>
        public Func<IExcel, ExcelDataTableConfiguration> ConfigureDataTable { get; set; }
        ...
        /// </summary>
        public Func<IExcel, int, bool> FilterSheet { get; set; }
    }
}
