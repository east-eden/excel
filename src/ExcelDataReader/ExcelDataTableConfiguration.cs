...
namespace Excel
{
    ...
    public class ExcelDataTableConfiguration
    {
        ...
        /// </summary>
        public Func<IExcel, int, bool> FilterColumn { get; set; }

        /// <summary>
        /// Gets or sets a callback to determine whether to transform the cell value.
        /// </summary>
        public Func<IExcel, int, object, object> TransformValue { get; set; }
    }
}
