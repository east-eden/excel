...
{
    /// <summary>
    /// Configuration options for an instance of Excel.
    /// </summary>
    public class ExcelReaderConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to leave the stream open after the IExcel object is disposed. Default: false
        /// </summary>
        public bool LeaveOpen { get; set; }

        /// <summary>
        /// Gets or sets a value indicating the number of rows to analyze for encoding, separator and field count in a CSV.
        /// When set, this option causes the IExcel.RowCount property to throw an exception.
