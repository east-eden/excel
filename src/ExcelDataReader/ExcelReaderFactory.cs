...
using Excel.Core.CompoundFormat;
using Excel.Core.OfficeCrypto;
...
namespace Excel
{
    ...
    public static class ExcelReaderFactory
    {
        ...
        public static IExcel CreateReader(Stream fileStream, ExcelReaderConfiguration configuration = null)
        {
        ...
        /// <param name="configuration">The configuration object.</param>
        /// <returns>The excel data reader.</returns>
        public static IExcel CreateBinaryReader(Stream fileStream, ExcelReaderConfiguration configuration = null)
        {
            if (configuration == null)
            {
                configuration = new ExcelReaderConfiguration();
        ...
        /// <returns>The excel data reader.</returns>
        public static IExcel CreateOpenXmlReader(Stream fileStream, ExcelReaderConfiguration configuration = null)
        {
            if (configuration == null)
            {
                configuration = new ExcelReaderConfiguration();
        ...
        /// <param name="configuration">The reader configuration -or- <see langword="null"/> to use the default configuration.</param>
        /// <returns>The excel data reader.</returns>
        public static IExcel CreateCsvReader(Stream fileStream, ExcelReaderConfiguration configuration = null)
        {
            if (configuration == null)
            {
                configuration = new ExcelReaderConfiguration();
