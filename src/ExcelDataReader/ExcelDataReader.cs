...
{
    /// <summary>
    /// A generic implementation of the IExcel interface using IWorkbook/IWorksheet to enumerate data.
    /// </summary>
    ...
    internal abstract class Excel<TWorkbook, TWorksheet> : IExcel
